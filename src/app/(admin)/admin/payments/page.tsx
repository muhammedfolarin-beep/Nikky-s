  ...
  return (
    <div className="pt-4">
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="bg-brand-midnight text-white px-4 py-2 rounded-lg text-sm font-medium">
          Export CSV
        </button>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
          ...
          <p className="text-gray-500 text-sm max-w-sm mb-6">
            Once your Paystack integration goes live, all processed payments and their statuses will appear here in real-time.
          </p>
          <button className="flex items-center gap-2 text-sm font-medium text-brand-midnight hover:text-brand-champagne transition-colors">
            Configure Payment Gateway <ArrowUpRight size={16} />
          </button>
        </div>
      </div>
    </div>
