  ...
  return (
    <div className="pt-4">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-semibold text-gray-800">Returns Management</h1>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No Active Returns</h3>
          <p className="text-gray-500 text-sm max-w-sm">
            When physical products are shipped back, you can track their warehouse status and condition here.
          </p>
        </div>
      </div>
    </div>
