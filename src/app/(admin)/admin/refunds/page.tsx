  ...
  return (
    <div className="pt-4">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-semibold text-gray-800">Refund Requests</h1>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col min-h-[500px]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
          ...
          <p className="text-gray-500 text-sm max-w-sm">
            When a customer initiates a return or refund, the request will appear here for you to review and process.
          </p>
        </div>
      </div>
    </div>
