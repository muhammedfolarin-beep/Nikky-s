...
import { ArrowRight, Star, Sparkles, Truck, Clock, ShieldCheck } from "lucide-react";
...
const DEFAULT_COLLECTIONS = [
  { name: "The SN24 Capsule", slug: "the-sn24-capsule", image: "https://images.unsplash.com/photo-1544022613-e87ca75a784a?q=80&w=1200&auto=format&fit=crop", desc: "Our signature high-fashion minimalist capsule" },
  { name: "The Midnight Navy Edit", slug: "the-midnight-navy-edit", image: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=1200&auto=format&fit=crop", desc: "Sculpted silhouettes tailored in deep obsidian and navy" },
  { name: "Soft White Minimalism", slug: "soft-white-minimalism", image: "https://images.unsplash.com/photo-1515347619362-747da441229a?q=80&w=1200&auto=format&fit=crop", desc: "Clean lines and breathable luxury textiles" }
];
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-between">
              <p className="text-xs sm:text-sm text-brand-silver/90 italic leading-relaxed mb-6 font-light">
                "Ordered to Lekki Phase 1 and local dispatch delivered next day. The fabric texture and seam construction are exceptional."
              </p>
              <div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex flex-col justify-between">
              <p className="text-xs sm:text-sm text-brand-silver/90 italic leading-relaxed mb-6 font-light">
                "Received in Abuja via GIG Express on time. The bespoke measurements fit like a dream."
              </p>
              <div>
